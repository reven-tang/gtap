...
这是一个使用Streamlit构建的股票分析和网格交易回测平台。网格交易是一种自动化交易策略,通过在价格区间内设置多个网格来进行买卖操作。当价格下跌时买入,上涨时卖出,从而在震荡行情中获利。该平台可以帮助用户设置网格参数,回测历史数据,评估网格交易策略的效果。关于网格交易的更多信息，可以参考[这篇文章](https://www.atfx.com/zh-hans/analysis/trading-strategies/what-is-grid-trading-how-does-it-work)。
...
*图1: 主界面展示了网格交易配置参数、股票基本信息、K线图和技术指标*
